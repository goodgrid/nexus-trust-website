...
**Proof.** Nexus Trust designed **and** built a Qualified Trust Service Provider (QTSP): set aside the predecessor's design because it was not certifiable, redesigned it, and realised it end to end — from writing the software to setting up the Root CA and Issuing CA, and from planning to executing the key ceremony. Lived experience of what most firms only claim on slides.
...
**Proof — the QTSP.**
- EN heading: *We have built what most only claim.* Body: We designed and built a Qualified Trust Service Provider end to end. We set aside our predecessors' design because it was not certifiable, redesigned it, and realised it ourselves — from the software to the Root CA and Issuing CA, from planning to executing the key ceremony. From conception to ceremony.
...
- [ ] Focus framed by situation (must be in control of trust-critical tech), not as a closed sector list; beachhead + wider ring + vision conveyed.
